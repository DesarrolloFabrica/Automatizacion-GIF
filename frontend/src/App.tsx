  ...
  return (
    <main className="app-shell">
      <header className="page-header">
        <p className="kicker">Automatización Académica GIF</p>
        <h1>Generador de Gránulos desde Syllabus</h1>
        <p className="subtitle">
          Flujo MVP: subir syllabus, detectar contenidos, preparar prompt por nivel y generar documentos reales con Python.
        </p>
      </header>
